                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" required v-model="formData.title" autocomplete="off" placeholder="请输入专题名称" maxlength="30" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
    ...
    require(['vue','helper','zh-cn','request','plupload','aliyun-oss','OssUpload'], function (Vue,$h) {
        new Vue({
            ...
            mounted: function () {
                ...
                layList.form.on('submit(formDemo)', function(data){
