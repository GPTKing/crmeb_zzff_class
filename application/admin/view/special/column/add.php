                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model="formData.title" autocomplete="off" placeholder="请输入专栏名称" maxlength="30" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <button type="button" class="layui-btn layui-btn-normal" @click='add_video_source'>
                                        添加视频专题
                                    </button>   <button type="button" class="layui-btn layui-btn-normal" @click='add_audio_source'>
                                        添加音频专题
                                    </button>   <button type="button" class="layui-btn layui-btn-normal" @click='add_img_source'>
                                        添加图文专题
                                    </button>
                ...
                show_source_list: function () {
                    ...
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'title', title: '标题', align: 'center', edit: 'title'},
