    ...
    <div class="layui-row layui-col-space15"  id="app">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">专栏专题</div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="store_name" class="layui-input" placeholder="专栏名称、简介、短语、编号">
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        return [
            ...
            {field: 'subject_name', title: '分类',align: 'center',width:80},
            ...
            {field: 'task_count', title: '专题数量',align: 'center',width:70},
