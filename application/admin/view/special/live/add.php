                ...
                <div class="layui-tab" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">直播标签：</label>
                                ...
                                <div class="layui-form-mid layui-word-aux" style="display:inline-block;">输入标签名称后点击“+”号按钮添加；最多写入6个字；点击标签即可删除</div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <input style="width: 300px;" type="text" name="live_time" v-model="formData.live_time" id="live_time" autocomplete="off" class="layui-input" placeholder="开播时间">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    <label class="layui-form-label" style="padding-left: 0;">直播时长(分钟)：</label>
                                    <div class="layui-input-block">
                                        <input style="width: 300px;" type="number" name="time" lay-verify="number" v-model="formData.live_duration" autocomplete="off" class="layui-input" placeholder="单位：分钟">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" v-if="formData.pay_type == 2">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <input style="width: 300px;" type="text" name="password" v-model="formData.password" lay-verify="password" placeholder="请输入密码" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    <label class="layui-form-label">确认密码：</label>
                                    <div class="layui-input-block">
                                        <input style="width: 300px;" type="text" name="qr_password" v-model="formData.qr_password" placeholder="请输入密码" class="layui-input">
                                    </div>
                                </div>
                            </div>
