                ...
                <div class="tabs-container ibox-title">
                    ...
                    <div class="ibox-content">
                        {if condition="$tab_id eq '17'"}
                            <div>若使用crmeb短信平台;请到[<b style="color: #2d8cf0;">设置</b>]中[<b style="color: #2d8cf0;">短信设置</b>]里配置[<a href="{:Url('admin/setting.system_plat/index')}" style="color: #2d8cf0;">短信账户</a>]</div>
                        {elseif condition="$tab_id eq '19'"/}
                           <div>若没有配置oss上传，请到[<b style="color: #2d8cf0;">设置</b>]中[<b style="color: #2d8cf0;">阿里云管理</b>]里配置[<a href="{:Url('admin/setting.system_bucket/index')}" style="color: #2d8cf0;">对象存储</a>]</div>
                        {elseif condition="$tab_id eq '21'"/}
                           <div>若没有配置阿里云直播，请到[<b style="color: #2d8cf0;">设置</b>]中[<b style="color: #2d8cf0;">阿里云管理</b>]里配置[<a href="{:Url('admin/setting.system_broadcast/index')}" style="color: #2d8cf0;">直播配置</a>]</div>
                        {/if}
